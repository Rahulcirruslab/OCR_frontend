...
import { registerUser } from "@/lib/api"; // Make sure this is the correct import path
      ...
      <div className="flex justify-center">
        <Card className="w-full max-w-md p-8 glass-card shadow-xl my-8">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <Button className="w-full gradient-primary py-5" type="submit" disabled={loading}>
              {loading ? "Registering..." : "Register"}
            </Button>
          </form>
          <div className="pt-4 text-center text-muted-foreground">
            Already have an account?{" "}
            <a href="/login" className="underline text-primary">Log in</a>
          </div>
        </Card>
      </div>
    </div>
